...
#[derive(Debug)]
pub struct PosthogEventProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PosthogEventProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PosthogEvent processing");
    
    let mut processor = PosthogEventProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PosthogEventProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PosthogEventProcessor::new(false);
